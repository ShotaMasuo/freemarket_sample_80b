class Profile < ApplicationRecord
  validates :first_name, presence: true, format: { with: /^[ぁ-んァ-ヶー一-龠]+$/, message: "姓は全角で入力してください"}
  validates :family_name, presence: true, format: { with: /^[ぁ-んァ-ヶー一-龠]+$/, message: "名は全角で入力してください"}
